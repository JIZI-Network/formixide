...
pub trait IFieldDefinition<T> {
    ...
    fn parse(&self, value: Vec<u8>) -> Result<T, Errors::ParseError>;
}

struct FieldDefinitionShortText {
    id: Uuid,
    name: String,
    is_required: bool,
}
...
impl IFieldDefinition<String> for FieldDefinitionShortText {
    ...
    fn parse(&self, value: Vec<u8>) -> Result<String, Errors::ParseError> {
        String::from_utf8(value)
            .map_err(|err| Errors::ParseError("Input string is not valid utf-8".to_string()))
    }
}
